    ...
    private void btnAttachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttachActionPerformed
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION){
            ...
            try{
                ...
                ImageItems = new ImageIcon(url);
                ImageItems = new ImageIcon(ImageItems.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH));

                imgLogo.setIcon(ImageItems);
...
//        if(ImageItems!=null){
        supplier.setImageItems(ImageItems);
//        }

        JOptionPane.showMessageDialog(this, "Profile successfully added", "Warning", JOptionPane.INFORMATION_MESSAGE);
        backAction();
...
//            System.out.println(ManageProductCatalogJPanel.class);
//            System.out.println(component.getClass()==ManageProductCatalogJPanel.class);
//            if(component.getClass()==ManageProductCatalogJPanel.class){
//                ManageProductCatalogJPanel manageProductCatalogJPanel = (ManageProductCatalogJPanel) component;
//                manageProductCatalogJPanel.refreshImage();
...
//        ImageItems = new ImageIcon(this.product.getProductImage().toString());
        if(this.supplier.getImageItems()!=null){
            ImageItems = new ImageIcon(this.supplier.getImageItems().getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH));
            imgLogo.setIcon(ImageItems);
        }
        imgLogo.setText("");
