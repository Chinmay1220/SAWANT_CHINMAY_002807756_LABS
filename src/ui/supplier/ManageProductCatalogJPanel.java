...
//        else imgLogo.setText("No Logo");
    ...
    public void refreshTable() {
     ...
     public void refreshImage() {
        if (supplier.getImageItems() != null) imgLogo.setIcon(supplier.getImageItems());   
        else imgLogo.setText("No Logo");
    }
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        System.out.println(selectedProduct.getProductImage());
        ViewProductDetailJPanel vpdj = new ViewProductDetailJPanel(workArea, selectedProduct);
        workArea.add("ViewProductDetailJPanelSupplier",vpdj);
