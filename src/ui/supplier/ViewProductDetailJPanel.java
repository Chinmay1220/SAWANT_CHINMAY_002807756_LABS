...
//        logoImage = new ImageIcon(this.product.getProductImage().toString());
...
//        manageProductCatalogJPanel.refreshTable();
    ...
    private void saveFeatures() {
       ...
       for(int i=0;i < model.getRowCount();i++){
           ...
           System.out.println(tblFeatures.getValueAt(i, 0));
           System.out.println(tblFeatures.getValueAt(i, 1));
